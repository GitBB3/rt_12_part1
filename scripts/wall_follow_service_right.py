...
def take_action():
    ...
    if regions['front'] > d0 and regions['fleft'] > d and regions['fright'] > d:
        ...
        change_state(2)  # follow wall (à gauche)
    elif regions['front'] > d0 and regions['fleft'] > d and regions['fright'] < d:
        ...
        state_description = 'case 7 - front and both sides'
        change_state(1)
    elif regions['front'] > d0 and regions['fleft'] < d and regions['fright'] < d:
...
def find_wall():
    msg = Twist()
    msg.linear.x = 0.2
    msg.angular.z = 0.3 #change the sign here
    return msg


def turn_left(): #could be renamed turn_right
    msg = Twist()
    msg.angular.z = -0.3 #change sign
    return msg
